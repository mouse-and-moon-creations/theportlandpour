...
const PitchBlock = props => {
  ...
  return (
    <div className={classes.pitch}>
      <Typography color="inherit" component="h2" variant="headline" align="center">Cocktail recipes using the local ingredients of Portland and the Pacific Northwest.</Typography>
